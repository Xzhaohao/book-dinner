package org.kuro.dinner.view.radioGroup;
...
public class MyRadioGroup extends LinearLayout {
    ...
    private MyRadioGroup.PassThroughHierarchyChangeListener mPassThroughListener;
    ...
    private void init() {
        mChildOnCheckedChangeListener = new MyRadioGroup.CheckedStateTracker();
        mPassThroughListener = new MyRadioGroup.PassThroughHierarchyChangeListener();
     ...
     */
    public void setOnCheckedChangeListener(MyRadioGroup.OnCheckedChangeListener listener) {
     ...
     */
    @Override
    public MyRadioGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
    ...
    protected LinearLayout.LayoutParams generateDefaultLayoutParams() {
        return new MyRadioGroup.LayoutParams(MyRadioGroup.LayoutParams.WRAP_CONTENT, MyRadioGroup.LayoutParams.WRAP_CONTENT);
    }
